...
type Intent = { kind: "Read", data: {} } | { kind: "Send", data: Send }

let decls: Decl[] = [
    { kind: "FreeText", tag: "Msg" },
    { kind: "Keywords", tag: "Time", data: ["now", "later"] },
    { kind: "TyDec", tag: "Send", data: { kind: "Rec", data: [["msg", { kind: "Def", data: "Msg" }], ["time", { kind: "Def", data: "Time" }]] } },
    { kind: "Trait", tag: "Intent", data: [["Read", { kind: "Rec", data: [] }], ["Send", { kind: "Def", data: "Send" }]] }
];
